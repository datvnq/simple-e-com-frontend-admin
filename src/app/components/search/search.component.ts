...
export class SearchComponent implements OnInit {
  ...
  handleKeyword(keyword: string) {
    ...
    if (hasCategoryId) {
      ...
      this.router.navigate(['/admin/products'], { queryParams: {categoryId: this.currentCategoryId, keyword: keyword} });
    }
    else {
      this.router.navigate(['/admin/products'], { queryParams: {keyword: keyword} });
    }
  }
